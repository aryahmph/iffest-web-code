...
function Details(props) {
    return (
        <div className="container mt-5 md:mt-10">
            <h1 className="text-3xl lg:text-4xl font-semibold text-secondary">Pura Uluwatu</h1>
            <h6 className="text-sm md:text-base text-gray-500 mt-2">Denpasar, Bali</h6>
            ...
            <div className="mt-12 md:max-w-3xl">
                ...
                <p className="mt-3 text-gray-700 text-sm md:text-base">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur beatae consequatur delectus deserunt
